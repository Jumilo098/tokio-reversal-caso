...
#define EA_VERSION "tokioreversal-2.00"

//==================== INPUTS ====================
input group "=== General ==="
input string SymbolLock          = "JPY";      // Candado: acepta cualquier par JPY (canasta v2)
...
input double RiskPercent         = 0.083;      // % por PATA (= riesgo del EVENTO / 3; 0.25%/evento -> 0.083)
...
#endif
   EventSetTimer(1);
   Print("TokioReversal v2.0 CANASTA en ", _Symbol, " | docs/07 Anexo v2 | eventos gotobi+fin-de-mes | sombra 10:15 ON");
